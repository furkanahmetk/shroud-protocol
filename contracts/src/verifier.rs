...
impl Verifier {
    ...
    pub fn verify(
        ...
        // relayer - convert Address to Fr
        public_inputs.push(address_to_fr(relayer));

        // fee - convert U512 to Fr
        public_inputs.push(u512_to_fr(fee));
...
/// Convert a Casper U512 to an ark Fr field element.
fn u512_to_fr(val: U512) -> Fr {
    // U512 is stored as little-endian limbs
